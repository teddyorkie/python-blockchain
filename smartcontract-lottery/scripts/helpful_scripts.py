from brownie import accounts, network, config, Contract, MockV3Aggregator, VRFCoordinatorMock, LinkToken, Lottery
...
def fund_with_link(contract_address, account=None, link_token=None, amount=100000000000000000): #0.1 Link
    ...
    tx = link_token.transfer(contract_address, amount, {"from":accountToUse})
    tx.wait(1)
    print("Fund contract!")
    return tx